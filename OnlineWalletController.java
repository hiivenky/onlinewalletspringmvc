...
public class OnlineWalletController {
	...
	public ModelAndView getTransactionsPage(@RequestParam("fromDate") Date fromDate,@RequestParam("toDate")Date toDate,
		...
		if(!user.getAccount().getAccountStatus().toString().equals("WatingForApproval")){
			...
			LocalDateTime tDate=LocalDateTime.of(date2, LocalTime.of(12,58));
			try {
